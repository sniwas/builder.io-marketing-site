// import ImgShape1 from "../../../assets/images/footer/shape-1.svg";
// import ImgShape3 from "../../../assets/images/footer/shape-3.svg";
...
export default component$(
  (props: {
    ...
    return (
      <footer
        class="wow fadeInUp  z-10 bg-black pt-20 lg:pt-[120px] "
        data-wow-delay=".15s"
      >
        <div class="container p-8 max-w-[1320px] justify-center mx-auto ">
            ...
            <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
              <div class="mb-10 w-full">
                ...
                <div class="-mx-3 flex items-center">
                  <a href="/" class="px-3 text-[#dddddd] hover:text-white">
                    <svg
                      width="10"
                      height="18"
                      viewBox="0 0 10 18"
        ...
        <div class="mt-12 border-t border-opacity-40 py-8 lg:mt-[60px]">
          <div class="container p-4 max-w-[1320px] justify-center mx-auto">
            <div class="-mx-4 flex flex-wrap">
              <div class="w-full px-8 md:w-2/3 lg:w-1/2">
                <div class="my-1">
                  <div class="-mx-3 flex items-center flex-col sm:flex-row justify-center md:justify-start">
                    <a
                      href="/"
              ...
              <div class="w-full px-4 md:w-1/3 lg:w-1/2">
                <div class="my-1 flex justify-center align-center text-center md:justify-end">
